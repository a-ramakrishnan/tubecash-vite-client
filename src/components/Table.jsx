...
function GlobalFilter({
  ...
  return (
    <label className="flex gap-x-2 items-baseline">
      ...
      <input
        type="text"
        className="rounded-md border-gray-300 text-gray-700 shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50"
        value={value || ""}
        onChange={(e) => {
                      ...
                      <tr {...row.getRowProps()}>
                        {row.cells.map((cell) => {
                          return (
                            <td
                              {...cell.getCellProps()}
                              className="text-xs px-2 py-2 text-gray-700"
                              role="cell"
                            >
